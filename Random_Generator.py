...
def generate_max_values_sets(n, m, max_init_runtime, max_runtime, max_deadline, max_weight):
    ...
    with open(f'MaxValuesSets/MaxValues_{ind_str}.txt', 'w') as f:
...
def generate_random_JS(MVS, JS, prnt=False):
    ...
    file_dir = f'MaxValuesSets/MaxValues_{MVS_str}/JobScheduling_{JS_str}'
    os.mkdir(file_dir) #create folder
    with open(f'{file_dir}/random_lists_{MVS_str}_{JS_str}.pickle', 'wb') as f:
